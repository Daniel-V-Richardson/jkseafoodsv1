...
const UpdateProduct = ({ history, match }) => {
  ...
  useEffect(() => {
    if (product && product._id !== productId) {
      ...
      setTamilDescription(product.tamilDescription);
      setPrice(product.price);
      setOrgPrice(product.orgprice);
  ...
  const updateProductSubmitHandler = (e) => {
    ...
    myForm.set("orgprice", orgprice);
    myForm.set("description", description);
    myForm.set("tamilDescription", tamilDescription);
        ...
        <div className="newProductContainer">
          ...
          >
            ...
            <div>
              ...
              ></textarea>
              <textarea
                placeholder="Product Description (Tamil)"
